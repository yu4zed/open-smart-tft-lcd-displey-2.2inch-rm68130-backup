...
#define HX8353C			30
#define ILI9327_8		31
#define ILI9220		32//not test yet
#define ST7735S_8	33//8bit
#define R61526_8    34//not test yet
#define HX8352B_8   35//8bit
#define R61580_8    36//8bit
#define RM68130     37//8bit
...
class UTFT
{
	public:
		UTFT();
		UTFT(byte model, int RS, int WR, int CS, int RST = 0x40, int SER=0);
		...
		void	drawRect(int x1, int y1, int x2, int y2, uint16_t c);
		...
		void	fillCircle(int x, int y, int radius, uint16_t c);
